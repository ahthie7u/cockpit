...
<a href="#"><img src="docs/assets/Logo.png" alt="Logo"/></a>
  ...
  <p align="center">
    ...
    <br />
    <a href="https://ahthie7u.github.io/cockpit/"><strong>Explore the docs »</strong></a>
    <br />
  </p>
</p>
...
<!--     pip install -e 'git+https://github.com/ahthie7u/cockpit.git' -->
...
With two simple tutorials we will show how one can use **Cockpit** to monitor training. More tutorials and detailed explanations of the individual parts of Cockpit can be found in the [documentation](https://ahthie7u.github.io/cockpit/).
...
A more detailed documentation with the API can be found [here](https://ahthie7u.github.io/cockpit/). The documentation also provides tutorials on how to add additional and custom quantities as well as add novel instruments to Cockpit.
